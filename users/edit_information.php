...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="../css/edit_inform/styles.css" />
...
<body id="contact" class="inner_page" data-spy="scroll" data-target="#navbar-wd" data-offset="98">
        ...
        <div class="back-pad" style="padding-right: 75px; padding-left: 75px;">
          <div class="messages columns row ad">
            <div class="column col-md-4">
              <ul class="nav-user">
                <li>
                  <a class="li01 is-active" href="edit_information.php">Quản lý tài khoản</a>
                </li>
                <li>
                ...
                <div class="row">
                  <div class="user-main column col-lg-9">
                    ...
                    <div class="form-change-pass user-form">
                      <div class="field">
                        <p class="txt">Email:</p>
                        <p class="control">
                          <input id="email" class="input" type="email" name="user_email" value="<?php echo $user["Email"] ?>" />
                        </p>
                      </div>
                    </div>
                    ...
                    <div class="form-change-pass user-form">
                      <div class="field">
                        ...
                        <p class="control">
                          <input class="input" type="text" id="fullname" name="fullname" value="<?php echo $user["Fullname"] ?>" />
                        </p>
                      </div>
                      <div class="field">
                        <p class="txt">Điện thoại</p>
                        <p class="control">
                          <input class="input" id="number" name="phone" type="number" value="<?php echo $user['Tel']; ?>" />
                        </p>
                      </div>
                  ...
                  <div class="column col-lg-3 ">
                    <div class="img d-flex justify-content-center">
                      <img class="image-avatar" id="uploaded_image" src="<?php echo ($user['Image']) == "" ? "../upload/user-avatar/noavatar.png" : "../upload/user-avatar/" . $user['Image']; ?>" alt="Avatar" />
  ...
  ?>
    <script type="text/javascript">
      ...
      window.location = "http://localhost/assignment/users/edit_information.php";
    </script>
  <?php
